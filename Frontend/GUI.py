...
def QueryModifier(Query):
    ...
    question_words = ["how", "when", "where", "what", "who", "which", "whose", "why", "whom", "what's", "can you", "how,s", "where's"]
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        self.gif_lebel = QLabel()
        self.gif_lebel.setStyleSheet("border: none;")
        movie = QMovie(GraphicsPath('AERIS.gif'))
        max_gif_size_W = 480
        max_gif_size_H = 270
        movie.setScaledSize(QSize(max_gif_size_W, max_gif_size_H))
        self.gif_lebel.setAlignment(Qt.AlignRight | Qt.AlignBottom)
        self.gif_lebel.setMovie(movie)
        movie.start()
        layout.addWidget(self.gif_lebel)
        self.lebel = QLabel("")
        self.lebel.setStyleSheet("color: white; font-size:16px; margin-right: 195px; border: none; margin-top: -30px;")
        self.lebel.setAlignment(Qt.AlignRight)
        layout.addWidget(self.lebel)
    ...
    def toggle_icon(self, event=None):
            if self.toggled:
                self.load_icon(GraphicsPath('voice.png'), 60, 60)
                MicButtonInitialed()

            else:
                self.load_icon(GraphicsPath('mic.png'), 60, 60)
                MicButtonClosed()
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.icon_lebel = QLabel()
        pixmap = QPixmap(GraphicsPath('Mic_on.png'))
        new_pixmap = pixmap.scaled(60, 60)
        self.icon_lebel.setPixmap(new_pixmap)
        self.icon_lebel.setFixedSize(150, 150)
        self.icon_lebel.setAlignment(Qt.AlignCenter)
        self.toggle_icon()
        self.icon_lebel.mousePressEvent = self.toggle_icon
        self.label = QLabel("")
        self.label.setStyleSheet("color: white; font-size:16px; margin-bottom:0;")
        content_layout.addWidget(gif_label, alignment=Qt.AlignCenter)
        content_layout.addWidget(self.label, alignment=Qt.AlignCenter)
        content_layout.addWidget(self.icon_lebel, alignment=Qt.AlignCenter)
...
class CustomTopBar(QWidget):
    ...
    def showMessageScreen(self):
            ...
            message_screen = MessageScreeen(self)
